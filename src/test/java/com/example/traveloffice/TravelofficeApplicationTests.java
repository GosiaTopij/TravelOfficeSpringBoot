...
public class TravelofficeApplicationTests {
    ...
    public void addAbroadTrip() throws Exception {
        ...
        abroadTrip.put("destination", "Paryż");
        ...
        mockMvc.perform(post("/add-trip/abroad/Paryż")
                .contentType(MediaType.APPLICATION_JSON)
    ...
    public void addDomesticTrip() throws Exception {
        ...
        domesticTrip.put("destination", "Paryż");
        ...
        mockMvc.perform(post("/add-trip/domestic/Paryż")
                .contentType(MediaType.APPLICATION_JSON)
